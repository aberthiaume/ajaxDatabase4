	...
	<head>
		...
		<script> 
			function clearFields(element){
				...
				{
					alert("firstname");
					$("#ajaxDiv").html("Deleting the database for user: " + firstname);
					$.ajax({
						url: "delete.php",
						method: "POST",
					...
					alert("lastname");
					$("#ajaxDiv").html("Deleting the database for user: " + lastname);
					$.ajax({
						url: "delete.php",
						method: "POST",
					...
					alert("email");
					$("#ajaxDiv").html("Deleting the database for user: " + email);
					$.ajax({
						url: "delete.php",
						method: "POST",
